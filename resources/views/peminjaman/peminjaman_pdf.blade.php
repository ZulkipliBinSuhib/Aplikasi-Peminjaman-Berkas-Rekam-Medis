  ...
  <table align="center">
    ...
    <table align="center">
        <tr>
            ...
            <td width="350px"> : {{$peminjaman->no_rm}}</td>
        </tr>
        <tr>
            <td>
                <font size="2">Nama Pasien
            </td>
            <td width="350px"> : {{$peminjaman->nama_pasien}}</td>
        </tr>
        <tr>
            <td>
                <font size="2">Diagnosa
            </td>
            <td width="350px"> : {{$peminjaman->diagnosa}}</td>
        </tr>
        <tr>
            <td>
                <font size="2">Tindakan
            </td>
            <td width="350px"> : {{$peminjaman->tindakan}}</td>
        </tr>
        <tr>
            <td>
            ...
            <td width="350px">
                <font size="2"> : {{$peminjaman->tanggal_berobat}}
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td width="350px">
                <font size="2"> : {{$peminjaman->tanggal_pinjam}}</td>
        </tr>
    ...
    <table align="center">
        <tr>
            <td width="400px"> </td>
            <td><font size="2">Cimahi Utara, {{$date}}</td>
        </tr>
    ...
    <table align="center">
        <tr>
            <td align="center">{{$peminjaman->nama_dokter}}</td>
            <td width="300px"> </td>
            <td align="center">{{$peminjaman->nama_petugas}}</td>
